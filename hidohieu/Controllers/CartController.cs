...
namespace hidohieu.Controllers
{
    public class CartController : Controller
    {
        ...
        public JsonResult Delete(int id)
        {
            ...
            sessionCart.RemoveAll(x => x.sach.MaSanPham == id);
        ...
        public JsonResult Update(string cartModel)
        {
            ...
            {
                var jsonItem = jsonCart.Single(x => x.sach.MaSanPham == item.sach.MaSanPham);
                if (jsonItem != null)
                {
        ...
        public ActionResult AddItem(int id, int quantity)
        {
            ...
            var sach = new AdminProcess().GetIdProduct(id);
            ...
            if (cart != null)
            {
                ...
                if (list.Exists(x => x.sach.MaSanPham == id))
                {

                    foreach (var item in list)
                    {
                        if (item.sach.MaSanPham == id)
                        {
        ...
        public ActionResult Payment(int MaKH)
        {
            ...
            try
            {
                ...
                foreach (var item in cart)
                {
                    ...
                    orderDetail.MaSanPham = item.sach.MaSanPham;
